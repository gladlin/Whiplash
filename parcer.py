...
def main():
    query = "бита"  # Потом надо добавить с проставлением цены и критерий отзывов, но сейчас хотя бы так работает - уже победа!
    driver = setup_driver()
    ...
    try:
        ...
        try:
            JsonHelper.write_list_to_json_file(results_wb)
