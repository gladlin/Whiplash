...
import JsonHelper
from Backend.AllItems.Utils.ShopClasses.Pyatyourochka import Pyatyourochka
from Backend.AllItems.Utils.ShopClasses.Wildberries import Wildberries
from Driver import setup_driver


def main():
    query = "Kinder"  # Потом надо добавить с проставлением цены и критерий отзывов, но сейчас хотя бы так работает - уже победа!
    driver = setup_driver()
